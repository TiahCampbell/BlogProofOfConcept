...
{
    public partial class blogposts3 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Contents",
                columns: new[] { "Id", "Author", "Body", "CategoryId", "ColorId", "Image", "PublishDate", "Title" },
                values: new object[] { 8, "Teacup", "Washburne is six years old now. Over the years he has learned to accept Nate playing guitar. Don't let that fool you though, this drama puppy used to lay there and cry anytime Nate even opened his guitar case as a wee pup.", 3, 7, "Images/Guitar.jpg", "03/09/21", "Guitar" });
        }
    }
}
